...
public class BacktesterUI {
    ...
    public Parent createUI() {
        ...
        scrollPane.setStyle("-fx-background: #0e1117; -fx-background-color: #0e1117;");
        try {
            String css = getClass().getResource("/Backtester/ui/styles/app.css").toExternalForm();
    ...
    private VBox createInputSection() {
        ...
        securityLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        TextField securityField = new TextField();
        securityField.setPromptText("e.g., AAPL, MSFT, GOOGL");
        securityField.setPrefWidth(150);
        securityField.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        
        // Date inputs
        Label startDateLabel = new Label("Start Date:");
        startDateLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        DatePicker startDatePicker = new DatePicker();
        startDatePicker.setPrefWidth(150);
        startDatePicker.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        
        Label endDateLabel = new Label("End Date:");
        endDateLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        DatePicker endDatePicker = new DatePicker();
        endDatePicker.setPrefWidth(150);
        endDatePicker.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        
        // Initial capital
        Label capitalLabel = new Label("Initial Capital ($):");
        capitalLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        TextField capitalField = new TextField();
        capitalField.setPromptText("100000");
        capitalField.setPrefWidth(150);
        capitalField.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        
        // Monte Carlo inputs
        Label permutationsLabel = new Label("Permutations:");
        permutationsLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        TextField permutationsField = new TextField();
        permutationsField.setPromptText("e.g., 100");
        permutationsField.setPrefWidth(120);
        permutationsField.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        ...
        statusLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        
        HBox buttonBox = new HBox(10, runButton, stopButton, progressBar, statusLabel);
        buttonBox.setAlignment(Pos.CENTER_RIGHT);
        
        // Add to grid (two rows of inputs)
        // Row 0: Security | Start Date | End Date
        ...
        // Row 1: Initial Capital | Permutations
        grid.add(capitalLabel, 0, 1);
        grid.add(capitalField, 1, 1);
        grid.add(permutationsLabel, 2, 1);
        grid.add(permutationsField, 3, 1);
        // Removed block size controls

        // Buttons row spans across all columns
    ...
    private VBox createStrategySection() {
        ...
        // Use rich StrategyEditor (syntax highlighting)
        CodeMirrorStrategyEditor editor = new CodeMirrorStrategyEditor();
        Node editorNode = editor.getNode();
        editorNode.setStyle("-fx-background-color: #121826;");
        // give it a reasonable height
        if (editorNode instanceof javafx.scene.layout.Region r) {
            r.setPrefHeight(160);
        }

        // Connect to controller
        controller.cmEditor = editor;

        section.getChildren().addAll(title, editorNode);
        return section;
    }
    ...
    private VBox createPerformanceSection() {
        ...
        netProfitLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label netProfitValue = new Label("$0.00");
        // Label netProfitValue = new Label("$0.00 (0%)"); // TODO: Add percentage calculation
        netProfitValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");

        Label grossProfitLabel = new Label("Gross Profit:");
        grossProfitLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label grossProfitValue = new Label("$0.00");
        // Label grossProfitValue = new Label("$0.00 (0%)"); // TODO: Add percentage calculation
        grossProfitValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");

        Label grossLossLabel = new Label("Gross Loss:");
        grossLossLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label grossLossValue = new Label("$0.00");
        // Label grossLossValue = new Label("$0.00 (0%)"); // TODO: Add percentage calculation
        grossLossValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");

        Label openPnLLabel = new Label("Open PnL:");
        openPnLLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label openPnLValue = new Label("$0.00");
        // Label openPnLValue = new Label("$0.00 (0%)"); // TODO: Add percentage calculation
        openPnLValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");

        Label maxDrawdownLabel = new Label("Max Drawdown:");
        maxDrawdownLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label maxDrawdownValue = new Label("$0.00");
        // Label maxDrawdownValue = new Label("$0.00 (0%)"); // TODO: Add percentage calculation
        maxDrawdownValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");

        Label maxRunUpLabel = new Label("Max Run Up:");
        maxRunUpLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label maxRunUpValue = new Label("$0.00");
        // Label maxRunUpValue = new Label("$0.00 (0%)"); // TODO: Add percentage calculation
        maxRunUpValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");

        Label sharpeRatioLabel = new Label("Sharpe Ratio:");
        sharpeRatioLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label sharpeRatioValue = new Label("0.00");
        // Label sharpeRatioValue = new Label("0.00 (0%)"); // TODO: Add percentage calculation
        sharpeRatioValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");

        // Add to grid (two rows only)
        // Row 0: core PnL metrics + Trades Made
        ...
        tradesMadeLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label tradesMadeValue = new Label("0");
        tradesMadeValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");
        metricsGrid.add(tradesMadeLabel, 8, 0);
        metricsGrid.add(tradesMadeValue, 9, 0);

        // Row 1: risk ratios + winners
        ...
        winningTradesLabel.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        Label winningTradesValue = new Label("0");
        winningTradesValue.setStyle("-fx-font-weight: bold; -fx-font-size: 14px; -fx-text-fill: #e0e6f1;");
        metricsGrid.add(winningTradesLabel, 6, 1);
        metricsGrid.add(winningTradesValue, 7, 1);
    ...
    private VBox createTradeHistorySection() {
        ...
        entryDateCol.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        ...
        entryPriceCol.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        ...
        exitDateCol.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        ...
        exitPriceCol.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        ...
        sideCol.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        ...
        quantityCol.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        ...
        statusCol.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
        ...
        pnlCol.setStyle("-fx-text-fill: #e0e6f1; -fx-font-weight: bold;");
