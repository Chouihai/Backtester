...
class PositionManagerTest {
    ...
    private InMemoryOrderCache orderCache;
    ...
    private int getTotalOpenQuantity() {
        return positionManager.getTotalOpenQuantity();
    }

    private int getTotalClosedQuantity() {
        return positionManager.getTotalClosedQuantity();
    }
    ...
    void testInitialState() {
        ...
        assertEquals(0, positionManager.closedTradeCount());
    ...
    void testEnterLongPosition() {
        ...
        assertEquals(1, positionManager.openTradeCount());
        assertEquals(0, positionManager.closedTradeCount());
    ...
    void testCloseLongPositionCompletely() {
        ...
        assertEquals(0, positionManager.openTradeCount());
        assertEquals(1, positionManager.closedTradeCount());
        assertEquals(0, getTotalOpenQuantity());
